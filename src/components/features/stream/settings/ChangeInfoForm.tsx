...
import { type TypeChangeStreamInfoSchema, changeStreamInfoSchema } from '@/schemas/stream/change-stream-info.schema';
...
export function ChangeInfoForm({ stream }: ChangeInfoFormProps) {
	...
	const { refetch: refetchChannel } = useFindChannelByUsernameQuery({
